...
function NavigationMenu({
  ...
  return (
    <NavigationMenuPrimitive.Root data-slot="navigation-menu" data-viewport={viewport} className={cn('group/navigation-menu relative flex items-center w-full', className)} {...props}>
      {children}
...
function NavigationMenuList({ className, ...props }: React.ComponentProps<typeof NavigationMenuPrimitive.List>) {
  return <NavigationMenuPrimitive.List data-slot="navigation-menu-list" className={cn('group flex list-none items-center justify-between gap-1', className)} {...props} />;
}
